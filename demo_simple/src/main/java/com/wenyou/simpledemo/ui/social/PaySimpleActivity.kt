...
import com.wenyou.simpledemo.databinding.SimplePayActivityBinding
import com.wenyou.sociallibrary.ext.pay.SDKPay
import com.wenyou.sociallibrary.ext.pay.SDKPayManager
...
/**
 * @description 支付示例（接口方式）
 * @date: 2021/8/23 16:28
 * @author: jy
 */
class PaySimpleActivity : BaseActivity<SimplePayActivityBinding>() {
