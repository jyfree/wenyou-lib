...
import com.wenyou.sociallibrary.media.*
...
object ShareUtils {
    ...
    fun getWeb(): JYWeb {
        ...
        jyWeb.thumb = JYImage(R.drawable.simple_share_icon)
...
//        val jyImage = JYImage(R.drawable.simple_share_icon)
//        val jyImage = JYImage(BitmapFactory.decodeResource(resources, R.drawable.simple_share_icon))
//        val jyImage = JYImage(File("/storage/emulated/0/200317190044044.jpg"))
        val jyImage = JYImage(
            bmp2ByteArray(
                BitmapFactory.decodeResource(
                    BaseUtils.getApp().resources,
                    R.drawable.simple_bg_bar
                )
            )
        )

        jyImage.thumb = JYImage(R.drawable.simple_share_icon)
        return jyImage
    }
    ...
    fun getAudio(): JYAudio {
        ...
        jyAudio.thumb = JYImage(R.drawable.simple_share_icon)
        return jyAudio
    }
...
//        val jyVideo = JYVideo(Environment.getExternalStorageDirectory().absolutePath + File.separator + "test.mp4")//微博分享
        ...
        jyVideo.thumb = JYImage(R.drawable.simple_share_icon)
        return jyVideo
    }
