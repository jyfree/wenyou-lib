package com.wenyou.sociallibrary.dialog;
...
import com.wenyou.sociallibrary.adapter.SDKAdapter2Share;
import com.wenyou.sociallibrary.bean.SDKShareChannel;
import com.wenyou.sociallibrary.utils.SDKScreenUtils;
...
public class SDKShareDialog extends Dialog {
    ...
    public SDKShareDialog(Context context, int themeResId,
                          List<SDKShareChannel> dataList,
                          OnSDKShareListener sdkShareListener) {
