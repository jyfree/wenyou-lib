...
import com.wenyou.yuilibrary.widget.banner.loopviewpager.FixedSpeedScroller;
import com.wenyou.yuilibrary.widget.banner.loopviewpager.LoopViewPager;
...
public abstract class BaseBanner<E, T extends BaseBanner<E, T>> extends RelativeLayout {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        int pageMargin = (int) ta.getDimensionPixelSize(R.styleable.BaseBanner_bb_pageMargin, 0);
        int pageHeight = (int) ta.getDimensionPixelSize(R.styleable.BaseBanner_bb_pageHeight, 0);
        int barHeight = (int) ta.getDimensionPixelSize(R.styleable.BaseBanner_bb_barHeight, 0);
        ...
        LayoutParams lp = new LayoutParams(mItemWidth, pageHeight > 0 ? pageHeight : mItemHeight);
         ...
         * 显示器(小点)的最顶层父容器
         */
        LayoutParams lpBarParent = new LayoutParams(mItemWidth, ViewGroup.LayoutParams.MATCH_PARENT);
        RelativeLayout mRlBottomBarParent = new RelativeLayout(context);
        addView(mRlBottomBarParent, lpBarParent);

        //container of indicators and title
        mLlBottomBar = new LinearLayout(context);
        LayoutParams lp2 = new LayoutParams(mItemWidth - (int) barGap * 2, barHeight > 0 ? barHeight : LayoutParams.WRAP_CONTENT);
    ...
    public BaseBanner setIsCanScroll(boolean isCanScroll) {
    ...
    private class InnerBannerAdapter extends PagerAdapter {
        ...
        public void destroyItem(ViewGroup container, int position, @NonNull Object object) {
            ...
            destroyInnerItem(container, position, object);
        }
    ...
    public void destroyInnerItem(ViewGroup container, int position, @NonNull Object object) {
    ...
    public BaseBanner setBannerClipChildren(boolean clipChildren) {
     ...
     * @return
     */
    public BaseBanner setOnItemLongClickListener(OnItemLongClickListener<E> onItemLongClickListener) {
